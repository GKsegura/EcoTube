<?php
    ...
    function add1($conecta, $cod_usuario, $cod_produto) {
    ...
    function del1($conecta, $cod_usuario, $cod_produto) {
    ...
    if (!empty($acao))
    {
        ...
        elseif($acao == 'add1'){
            add1($conecta, $cod_usuario, $cod_produto);
        }
        elseif($acao == 'del1'){
            del1($conecta, $cod_usuario, $cod_produto);
        }
